      ...
      <ul v-on-clickaway="hideDropdown" v-if="isVisible" ref="dropdown" class="absolute normal-case z-30 font-normal xs:left-0 lg:right-0 bg-white shadow overflow-hidden rounded w-48 border mt-2 py-1 lg:z-20">
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="@/assets/flag_en.png" style="width: 25px; margin-right: 10px" alt="english flag" class="h-8 w-8">
        ...
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="@/assets/flag_vi.png" style="width: 25px; margin-right: 10px" alt="vietnam flag" class="h-8 w-8">
            <span class="ml-2">Viet Nam</span>
          </a>
        </li>
      </ul>
    </transition> -->
