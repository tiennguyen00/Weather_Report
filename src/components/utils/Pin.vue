  ...
  <div class="widget-container">
    ...
    <div class="top-right" v-for="item in weatherDescription" :key="item.index">
      ...
      <div v-show="String(item.id)[0] == '3'" class="icon sun-shower">
       ...
       <div v-show="String(item.id)[0] == '5'" class="icon rainy">
        <div class="cloud"></div>
        <div class="rain"></div>
      </div>

      <div v-show="String(item.id)[0] == '6'" class="icon flurries">
        <div class="cloud"></div>
        <div class="snow">
          <div class="flake"></div>
          <div class="flake"></div>
      ...
      <div v-show="String(item.id) == '800'" class="icon sunny">
        <div class="sun">
          <div class="rays"></div>
        </div>
      </div>

      <div v-show="String(item.id)[0] == '7' || String(item.id)[0] == '8'" class="icon cloudy">
        <div class="cloud"></div>
        <div class="cloud"></div>
      </div>
    </div>
